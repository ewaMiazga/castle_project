...
export async function load_resources(regl) {
	...
	*/
	...
	const meshes_to_load = [
		...
		"vase_centered.obj", "tempCastle1.obj", "tempCastleColumn.obj", "tower.obj", "castle 22.4.2023.obj"
	]
...
export function create_scene_content_reflections() {
	...
	const actors = [
		...
		},*/
		{
			...
			mesh: 'castle 22.4.2023.obj',
			color: [0.714, 0.427, 0.051]
	...
	const actors = [
		{
			...
			material: {
				texture: 'outdoor_umbrellas_2k.webp',
			}
		},
