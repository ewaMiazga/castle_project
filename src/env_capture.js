...
export class EnvironmentCapture {
	...
	init_capture(regl) {
		...
		*/
		...
		console.log(this.capture_scene_cubemap);
		let mat_proj = mat4.perspective(mat4.create(), 90.0 * deg_to_rad, aspect_ratio, 0.1, 200.0);
		this.cube_camera_projection = mat_proj;
